...
- Price increases ~exponentially with carat for lower carat diamonds (~<2 carats). 
- Higher carat diamonds do generally fetch an higher price, though the increase isn't quite a rapid as lower carat diamonds. 
...
- Ideal cuts most common for smaller carrat diamonds and has ~ exponential curve. 
